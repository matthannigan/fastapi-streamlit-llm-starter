...
2.  **No Internal Mocking**: Your test plans **must not** rely on mocking any internal part of the `[component]`. The docstrings should only reference fixtures for dependencies that are **external** to the component.
