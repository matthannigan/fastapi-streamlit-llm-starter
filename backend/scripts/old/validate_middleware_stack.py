...
def create_test_app() -> FastAPI:
    ...
    settings = Settings(
        ...
        allowed_origins=["http://localhost:8501", "http://frontend:8501"],  # Correct CORS setting
    ...
    def validate_middleware_order(self) -> bool:
        ...
        try:
            ...
            for middleware in self.app.user_middleware:
                # Safely get a readable middleware class name for logging and validation
                middleware_name = getattr(middleware.cls, "__name__", type(middleware.cls).__name__)
