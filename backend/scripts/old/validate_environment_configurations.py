    ...
    def __init__(self):
        ...
        self.environment_test_cases = [
            ...
            },
            {
                ...
                'expected_middleware_count': 4  # Security, logging, CORS, global exception handler
            },
            {
            ...
            # Redis configuration variations
            {
                ...
                'expected_features': ['rate_limiting_redis']
            },
            {
                ...
                'expected_features': ['rate_limiting_local']
            },
            ...
            # Complex configuration combinations
            {
                ...
                'expected_middleware_count': 8,
                'expected_features': ['production_optimized']
            }
        ]
            ...
            if middleware_result.get('success'):
                ...
                if 'expected_features' in test_case:
                    ...
                    for feature in expected_features:
                        if feature not in enabled_features:
                            expectations_met = False
                            expectation_failures.append(f"Missing expected feature: {feature}")
...
def main():
    ...
    print("=" * 80)
    print("Environment Variable and Preset Configuration Validation")
    print("=" * 80)
    ...
    try:
        ...
        results_file = '/Users/matth/Github/MGH/fastapi-streamlit-llm-starter/backend/environment_validation_report.json'
