...
async def get_health_checker(settings: Settings = Depends(get_settings)) -> HealthChecker:
    ...
    if hasattr(settings, "health_check_component_timeouts_ms"):
        per_component_timeouts_ms = settings.health_check_component_timeouts_ms  # type: ignore
    ...
    async def cache_health_with_service() -> ComponentStatus:
...
def create_dependency_factory(settings_obj: Settings) -> Any:
    ...
    class DependencyFactory:
        ...
        def __init__(self, settings: Settings):
            ...
            self._cache_service: CacheInterface | None = None
            self._health_checker: HealthChecker | None = None

        async def get_cache_service(self) -> CacheInterface:
            ...
            assert self._cache_service is not None
        ...
        async def get_health_checker(self) -> HealthChecker:
            ...
            if self._health_checker is None:
                ...
                if hasattr(self.settings, "health_check_component_timeouts_ms"):
                    per_component_timeouts_ms = self.settings.health_check_component_timeouts_ms  # type: ignore
        ...
        def get_health_checker_dep(self) -> Any:
