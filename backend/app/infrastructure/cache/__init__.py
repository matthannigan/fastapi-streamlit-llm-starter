...
# Version information
__version__ = "4.0.0"  # Major version bump for security-first breaking changes

# Module metadata
__author__ = "FastAPI Streamlit LLM Starter"
__description__ = (
    "Security-first caching infrastructure with mandatory TLS encryption and data encryption. "
    "Features Redis and in-memory implementations with always-on security, explicit cache factory "
    "patterns, enhanced configuration management with builder pattern, and comprehensive FastAPI "
    "dependency injection with lifecycle management. All Redis connections require TLS (rediss://), "
    "authentication, and Fernet encryption for cached data."
)
