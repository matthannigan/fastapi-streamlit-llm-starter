        ...
        try:
            ...
            if not connected:
                if fail_on_connection_error:
                    ...
                    logger.warning(f"Redis connection failed, falling back to InMemoryCache")
        ...
        try:
            ...
            if not connected:
                if fail_on_connection_error:
                    ...
                    # Fall back to InMemoryCache
                    logger.warning(f"Redis connection failed, falling back to InMemoryCache for testing")
                    return InMemoryCache(
                        default_ttl=default_ttl,
                        max_size=l1_cache_size
                    )
