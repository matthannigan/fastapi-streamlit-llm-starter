...
class CacheParameterMapper:
    ...
    def _add_configuration_recommendations(self, ai_params: Dict[str, Any], result: ValidationResult) -> None:
        ...
        # Recommend using l1_cache_size instead of memory_cache_size for consistency
        if 'memory_cache_size' in ai_params and 'l1_cache_size' not in ai_params:
            result.add_recommendation(
                "Consider using 'l1_cache_size' instead of 'memory_cache_size' "
                "for better compatibility with GenericRedisCache"
            )
