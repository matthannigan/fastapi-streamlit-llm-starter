...
async def get_monitoring_health(
    ...
    try:
        ...
        # Type annotation for components dict to satisfy MyPy
        components: Dict[str, Any] = monitoring_health["components"]
        ...
        try:
            ...
            if hasattr(cache_service, "performance_monitor") and cache_service.performance_monitor is not None:
                ...
                components["cache_performance_monitor"] = {
                    "status": "healthy",
        ...
        try:
            ...
            components["cache_service_monitoring"] = {
                "status": "healthy",
        ...
        try:
            ...
            components["resilience_monitoring"] = {
                "status": "healthy",
        ...
        raise HTTPException(
            ...
            detail=f"Failed to get monitoring health: {e!s}"
        )
