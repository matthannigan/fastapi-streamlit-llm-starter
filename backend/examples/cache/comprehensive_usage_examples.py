"""
Comprehensive Cache Usage Examples

This module demonstrates practical usage patterns for the cache infrastructure
across different application types, environments, and use cases.

Examples included:
1. Simple web app setup
2. AI app setup
3. Hybrid app setup
...
9. Migration from auto-detection
