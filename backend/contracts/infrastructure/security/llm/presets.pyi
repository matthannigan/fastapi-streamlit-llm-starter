...
def create_preset(name: str, description: str, input_scanners: Dict[str, Any], output_scanners: Dict[str, Any], performance_overrides: Dict[str, Any] | None = None, logging_overrides: Dict[str, Any] | None = None) -> Dict[str, Any]:
    """
