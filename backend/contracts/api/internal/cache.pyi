...
@router.post('/benchmark/basic-operations', summary='Run Basic Cache Operations Benchmark', description='Execute comprehensive benchmarking of basic cache operations (get/set/delete) with detailed timing analysis.', dependencies=[Depends(verify_api_key)], responses={200: {'description': 'Benchmark completed successfully', 'content': {'application/json': {'example': {'operation_type': 'basic_operations', 'avg_duration_ms': 25.5, 'p95_duration_ms': 45.2, 'p99_duration_ms': 52.1, 'operations_per_second': 39.2, 'success_rate': 0.98, 'memory_usage_mb': 5.2, 'iterations': 100, 'performance_grade': 'Good'}}}}, 400: {'description': 'Invalid benchmark parameters (ValidationError)'}, 401: {'description': 'Authentication required'}, 500: {'description': 'Benchmark execution failed (InfrastructureError)'}})
...
@router.post('/benchmark/memory-cache', summary='Run Memory Cache Performance Benchmark', description='Execute memory cache specific benchmarking including L1 cache hit rates and eviction behavior.', dependencies=[Depends(verify_api_key)], responses={200: {'description': 'Memory cache benchmark completed successfully', 'content': {'application/json': {'example': {'operation_type': 'memory_cache_performance', 'avg_duration_ms': 2.1, 'cache_hit_rate': 85.5, 'memory_hit_rate': 65.2, 'operations_per_second': 476.0, 'success_rate': 1.0, 'performance_grade': 'Excellent'}}}}, 400: {'description': 'Invalid benchmark parameters'}, 401: {'description': 'Authentication required'}, 500: {'description': 'Benchmark execution failed'}})
...
@router.post('/benchmark/compression', summary='Run Compression Efficiency Benchmark', description='Execute compression performance testing with different data types and efficiency analysis.', dependencies=[Depends(verify_api_key)], responses={200: {'description': 'Compression benchmark completed successfully', 'content': {'application/json': {'example': {'operation_type': 'compression_efficiency', 'avg_duration_ms': 45.3, 'compression_ratio': 0.42, 'compression_savings_mb': 2.8, 'operations_per_second': 22.1, 'success_rate': 0.98}}}}, 400: {'description': 'Invalid benchmark parameters'}, 401: {'description': 'Authentication required'}, 500: {'description': 'Benchmark execution failed'}})
...
@router.post('/benchmark/comprehensive', summary='Run Comprehensive Benchmark Suite', description='Execute complete benchmark suite covering all cache performance aspects with detailed analysis.', dependencies=[Depends(verify_api_key)], responses={200: {'description': 'Comprehensive benchmark suite completed successfully', 'content': {'application/json': {'example': {'name': 'Comprehensive Cache Performance Benchmark', 'pass_rate': 1.0, 'performance_grade': 'Good', 'memory_efficiency_grade': 'Excellent', 'total_duration_ms': 5432.1, 'results': [{'operation_type': 'basic_operations', 'avg_duration_ms': 25.5}, {'operation_type': 'memory_cache_performance', 'avg_duration_ms': 2.1}], 'failed_benchmarks': []}}}}, 401: {'description': 'Authentication required'}, 500: {'description': 'Benchmark suite execution failed'}})
...
@router.get('/benchmark/results/{benchmark_id}', summary='Get Benchmark Results', description='Retrieve stored benchmark results by ID with optional report generation.', dependencies=[Depends(verify_api_key)], responses={200: {'description': 'Benchmark results retrieved successfully'}, 404: {'description': 'Benchmark results not found'}, 401: {'description': 'Authentication required'}})
