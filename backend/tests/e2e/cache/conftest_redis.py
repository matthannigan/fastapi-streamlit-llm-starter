...
REDIS_PRESET_SCENARIOS = [
    ...
    ("simple", "connected", "active"),           # Simple preset with Redis available via testcontainers
    ("disabled", "connected", "active")          # Even disabled presets may show Redis connected when testcontainers provides Redis
]
