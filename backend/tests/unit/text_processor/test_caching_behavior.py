...
class TestTextProcessorCachingStrategy:
    ...
    async def test_cache_hit_returns_cached_response_without_ai_call(self):
        """
    ...
    async def test_cache_miss_triggers_ai_processing_and_stores_result(self):
        """
    ...
    async def test_cache_check_occurs_before_input_sanitization(self):
        """
    ...
    async def test_cache_storage_after_successful_ai_processing(self):
        """
    ...
    async def test_cache_hit_includes_cache_metadata_in_response(self):
        """
    ...
    async def test_cache_miss_includes_cache_metadata_in_response(self):
        """
...
class TestTextProcessorCacheKeyGeneration:
    ...
    async def test_cache_key_includes_operation_type(self):
        """
    ...
    async def test_cache_key_includes_text_content(self):
        """
    ...
    async def test_cache_key_includes_options_when_provided(self):
        """
    ...
    async def test_cache_key_includes_question_for_qa_operation(self):
        """
    ...
    async def test_cache_key_generation_delegates_to_cache_service(self):
        """
...
class TestTextProcessorCacheTTLManagement:
    ...
    async def test_summarize_operation_uses_configured_ttl(self):
        """
    ...
    async def test_sentiment_operation_uses_shorter_ttl(self):
        """
    ...
    async def test_qa_operation_uses_shortest_ttl(self):
        """
    ...
    async def test_different_operations_use_different_ttls(self):
        """
    ...
    async def test_ttl_retrieval_from_operation_config_registry(self):
        """
...
class TestTextProcessorCacheBehaviorIntegration:
    ...
    async def test_first_request_stores_second_request_hits_cache(self):
        """
    ...
    async def test_cache_effectiveness_with_varied_requests(self):
        """
    ...
    async def test_cache_handles_concurrent_identical_requests(self):
        """
