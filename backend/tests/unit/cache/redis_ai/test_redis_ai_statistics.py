...
class TestAIResponseCacheStatistics:
    ...
    async def test_get_cache_stats_returns_comprehensive_statistics(
    ...
    async def test_get_cache_stats_handles_redis_failure_gracefully(
        self, valid_ai_params
    ):
        """
    ...
    def test_get_ai_performance_summary_includes_comprehensive_ai_analytics(
        self, valid_ai_params
    ):
        """
    ...
    def test_get_text_tier_statistics_analyzes_text_size_patterns(
        self, valid_ai_params
    ):
        """
    ...
    def test_get_operation_performance_provides_detailed_operation_metrics(
        self, valid_ai_params
    ):
        """
        ...
        for operation, metrics in operations.items():
            ...
            assert (
                metrics["configured_ttl"]
                == valid_ai_params["operation_ttls"][operation]
            )
