...
class TestCacheConfigBuilderInitialization:
    ...
    def test_builder_methods_return_self_for_fluent_chaining(self):
        ...
        chained_result = (CacheConfigBuilder()
    ...
    def test_builder_accumulates_configuration_through_method_calls(self, builder_with_basic_config):
        ...
        assert builder._config.environment == "production"  # Previously set parameter preserved
        ...
        assert builder_with_basic_config._config.environment == "development"  # Preserved
        assert builder_with_basic_config._config.redis_url == "redis://test:6379"  # Preserved
        assert builder_with_basic_config._config.compression_threshold == 2000  # New parameter
...
class TestCacheConfigBuilderEnvironmentConfiguration:
    ...
    def test_for_environment_configures_development_environment_optimizations(self):
        ...
        assert builder._config.default_ttl == 1800  # 30 minutes - shorter for dev iteration
        ...
        assert builder._config.compression_level == 4  # Lower compression level for speed
    ...
    def test_for_environment_configures_production_environment_optimizations(self):
        ...
        assert builder._config.default_ttl == 7200  # 2 hours - longer for production efficiency
        
        # Assert: Production-appropriate cache size for workload requirements
        assert builder._config.memory_cache_size == 200  # Larger for production workloads
        
        # Assert: Production-optimized compression settings
        assert builder._config.compression_threshold == 1000  # Lower threshold for better compression
        assert builder._config.compression_level == 6  # Higher compression for storage efficiency
    ...
    def test_for_environment_validates_supported_environments(self):
        ...
        assert builder._config.environment == "production"  # Still the last valid setting
...
class TestCacheConfigBuilderFileAndEnvironmentLoading:
    ...
    def test_from_file_loads_valid_json_configuration_file(self, temp_config_file, sample_config_file_content):
        ...
        assert builder._config.environment == "testing"  # From file, overwrites "development"
...
class TestCacheConfigBuilderBuildAndValidation:
    ...
    def test_build_method_raises_validation_error_for_invalid_configuration(self, invalid_config_params):
        ...
        builder._config.default_ttl = invalid_config_params["default_ttl"]  # -100 (negative)
        builder._config.memory_cache_size = invalid_config_params["memory_cache_size"]  # 0 (zero)
        builder._config.compression_level = invalid_config_params["compression_level"]  # 15 (out of range)
        builder._config.compression_threshold = invalid_config_params["compression_threshold"]  # -50 (negative)
