...
class TestComplexCustomConfigurationScenarios:
    ...
    def test_multi_layer_configuration_override(self):
        ...
        with patch.dict(os.environ, env_overrides):
            ...
            # Environment should take precedence over custom config
            assert config.circuit_breaker_config.failure_threshold == 12  # From env
            # Custom config should take precedence over preset for non-env values
    ...
    def test_configuration_inheritance_chain(self):
        ...
        with patch.dict(os.environ, env_overrides):
            ...
            assert config.circuit_breaker_config.failure_threshold == 15  # From environment
