...
from app.resilience_presets import StrategyType
...
class TestResilienceConvenienceDecorators:
    ...
    def test_with_operation_resilience_decorator(self):
        ...
        from app.services.resilience import with_operation_resilience
