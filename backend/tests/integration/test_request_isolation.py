...
class TestContextIsolation:
    ...
    def test_sequential_requests_no_context_leakage(self, client, headers):
        ...
        response1 = client.post("/v1/text_processing/process", json=request1_data, headers=headers)
        ...
        response2 = client.post("/v1/text_processing/process", json=request2_data, headers=headers)
    ...
    def test_injection_attempt_isolation(self, client, headers):
        ...
        response1 = client.post("/v1/text_processing/process", json=injection_request, headers=headers)
        assert response1.status_code == 200
        result1 = response1.json()
        ...
        response2 = client.post("/v1/text_processing/process", json=normal_request, headers=headers)
        assert response2.status_code == 200
        result2 = response2.json()
    ...
    async def test_concurrent_requests_isolation(self, headers):
        ...
        async with AsyncClient(transport=ASGITransport(app=app), base_url="http://test") as client:
            ...
            for req_data in requests:
                task = client.post("/v1/text_processing/process", json=req_data, headers=headers)
                tasks.append(task)
    ...
    def test_cache_isolation_by_content(self, client, headers, mock_cache_service):
        ...
        response1 = client.post("/v1/text_processing/process", json=request_data, headers=headers)
        response2 = client.post("/v1/text_processing/process", json=request_data, headers=headers)
        ...
        response3 = client.post("/v1/text_processing/process", json=different_request, headers=headers)
    ...
    def test_different_operations_isolation(self, client, headers):
        ...
        response1 = client.post("/v1/text_processing/process", json=sentiment_request, headers=headers)
        assert response1.status_code == 200
        result1 = response1.json()
        ...
        response2 = client.post("/v1/text_processing/process", json=summary_request, headers=headers)
        assert response2.status_code == 200
        result2 = response2.json()
    ...
    def test_qa_operation_isolation(self, client, headers):
        ...
        response1 = client.post("/v1/text_processing/process", json=qa_request, headers=headers)
        assert response1.status_code == 200
        result1 = response1.json()
    ...
    async def test_batch_processing_isolation(self, headers):
        ...
        async with AsyncClient(transport=ASGITransport(app=app), base_url="http://test") as client:
            ...
            response = await client.post("/v1/text_processing/batch_process", json=batch_request, headers=headers)
    ...
    def test_error_handling_isolation(self, client, headers):
        ...
        response1 = client.post("/v1/text_processing/process", json=error_request, headers=headers)
