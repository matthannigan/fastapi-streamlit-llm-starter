...
def development_settings(monkeypatch):
    ...
    Yields:
        Settings: Real Settings instance with development configuration
    ...
    # Set development environment variables using monkeypatch (proper pattern)
    test_env = {
    ...
    # Create and yield Settings instance
    # monkeypatch automatically restores environment after test
    yield Settings()
...
def production_settings(monkeypatch):
    ...
    Yields:
        Settings: Real Settings instance with production configuration
    ...
    # Set production environment variables using monkeypatch (proper pattern)
    test_env = {
